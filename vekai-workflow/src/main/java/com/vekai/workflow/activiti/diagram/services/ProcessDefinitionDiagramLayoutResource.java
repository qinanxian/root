...
package com.vekai.workflow.activiti.diagram.services;
...
/**
 * Restful路径配置文件vekai-workflow\src\main\resources\static\diagram-viewer\index.html
 */
@RestController
public class ProcessDefinitionDiagramLayoutResource extends BaseProcessDefinitionDiagramLayoutResource {

  @RequestMapping(value="/workflow/diagram/process-definition/{processDefinitionId}/diagram-layout", method = RequestMethod.GET, produces = "application/json")
