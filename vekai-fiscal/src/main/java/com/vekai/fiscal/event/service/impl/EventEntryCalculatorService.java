...
/**
 * Created by luyu on 2018/7/2.
 */
@Component
public class EventEntryCalculatorService {
    ...
    private List<String> resolveExpr(String exp) {
        ...
        for (int i = 0; i < exp.length(); i++) {
            ...
            if (op != null) {
                ...
                throw new BizException("表达式[" + str + "]非法! ");
                //return null;
            }
        }
        if (!temp.isEmpty()) {
