...
/** 记账事件分录 */
@Table(name="FISC_EVENT_ENTRY")
public class FiscEventEntryPO implements Serializable,Cloneable{
    /** 事件ID */
    ...
    /** 匹配到的账套 */
    private Integer matchBookCount ;
    /** 匹配到的账套数量;多个，用逗号分开 */
    ...
    /** 匹配到的账套 */
    public Integer getMatchBookCount(){
        return this.matchBookCount;
    }
    /** 匹配到的账套 */
    public void setMatchBookCount(Integer matchBookCount){
        this.matchBookCount = matchBookCount;
    }
    /** 匹配到的账套数量;多个，用逗号分开 */
    public String getMatchBookId(){
        return this.matchBookId;
    }
    /** 匹配到的账套数量;多个，用逗号分开 */
