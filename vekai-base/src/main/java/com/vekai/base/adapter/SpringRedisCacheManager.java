...
/**
 * this class originates from {@link RedisCacheManager}
 */
public class SpringRedisCacheManager extends AbstractTransactionSupportingCacheManager {

    private final RedisCacheWriterExt cacheWriter;
     ...
     * @since 2.0.4
     */
    private SpringRedisCacheManager(RedisCacheWriterExt cacheWriter, RedisCacheConfiguration defaultCacheConfiguration,
     ...
     *          {@link RedisCacheConfiguration#defaultCacheConfig()}.
     */
    public SpringRedisCacheManager(RedisCacheWriterExt cacheWriter, RedisCacheConfiguration defaultCacheConfiguration) {
    ...
    public static RedisCacheManager create(RedisConnectionFactory connectionFactory) {
        ...
        return new RedisCacheManager(new RedisCacheWriterExt(connectionFactory),
     ...
     * @return new {@link RedisCacheManagerBuilder}.
     */
    public static RedisCacheManagerBuilder builder(RedisCacheWriterExt cacheWriter) {
    ...
    protected RedisCache createRedisCache(String name, @Nullable RedisCacheConfiguration cacheConfig) {
        return new SpringRedisCache(name, cacheWriter, cacheConfig != null ? cacheConfig : defaultCacheConfig);
    }
    ...
    public static class RedisCacheManagerBuilder {
        ...
        private RedisCacheManagerBuilder(RedisCacheWriterExt cacheWriter) {
            this.cacheWriter = cacheWriter;
        }
        ...
        public static RedisCacheManagerBuilder fromConnectionFactory(RedisConnectionFactory connectionFactory) {
            ...
            return builder(new RedisCacheWriterExt(connectionFactory));
        }
         ...
         * @return new {@link RedisCacheManagerBuilder}.
         */
        public static RedisCacheManagerBuilder fromCacheWriter(RedisCacheWriterExt cacheWriter) {
         ...
         * @return new instance of {@link RedisCacheManager}.
         */
        public SpringRedisCacheManager build() {

            SpringRedisCacheManager cm = new SpringRedisCacheManager(cacheWriter, defaultCacheConfiguration, initialCaches,
