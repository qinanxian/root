...
import cn.fisok.sqloy.serialnum.cursor.mapper.SerialNumberCursorMapper;
...
public class SerialNumberCursorDao4Mybatis implements SerialNumberCursorDao {

    @Autowired(required = false)
    SerialNumberCursorMapper serialNoCursorMapper;
    ...
    public void insertOne(SerialNumberCursor serialNumberCursor) {
        serialNoCursorMapper.insertOne(serialNumberCursor);
    }

    public void increase(String generatorId, int count) {
        serialNoCursorMapper.increaseBatch(generatorId,count);
    }
