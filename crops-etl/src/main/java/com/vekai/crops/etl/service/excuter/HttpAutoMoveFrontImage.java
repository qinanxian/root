 ...
 */
@Component
public class HttpAutoMoveFrontImage implements JavaExcuter {
    ...
    public JavaResult execute(ScheduleJob scheduleJob) {
        ...
        String rstMsg = restTemplate.getForObject(MicroServerName.risk_service_http+"/file/etl/moveFrontImage", String.class);
