 ...
 */
@Component
public class HttpAutoDataMing implements JavaExcuter {
    ...
    public JavaResult execute(ScheduleJob scheduleJob) {
        ...
        String rstMsg = restTemplate.getForObject(MicroServerName.risk_service_http+"/comn/file/getCustomer", String.class);

        javaResult.setMsg(rstMsg);
        LOGGER.info("添加客户："+rstMsg);
