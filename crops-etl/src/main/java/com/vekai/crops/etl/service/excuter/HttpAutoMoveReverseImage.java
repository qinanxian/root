 ...
 */
@Component
public class HttpAutoMoveReverseImage implements JavaExcuter {
    ...
    public JavaResult execute(ScheduleJob scheduleJob) {
        ...
        String rstMsg = restTemplate.getForObject(MicroServerName.risk_service_http+"/file/etl/moveReverseImage", String.class);
