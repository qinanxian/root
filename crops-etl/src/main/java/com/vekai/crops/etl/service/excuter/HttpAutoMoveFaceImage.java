 ...
 */
@Component
public class HttpAutoMoveFaceImage implements JavaExcuter {
    ...
    public JavaResult execute(ScheduleJob scheduleJob) {
        ...
        String rstMsg = restTemplate.getForObject(MicroServerName.risk_service_http+"/file/etl/moveFaceImage", String.class);
