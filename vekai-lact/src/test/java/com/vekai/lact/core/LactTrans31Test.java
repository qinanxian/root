 ...
 * 测试案例[确定本金]
 */
public class LactTrans31Test extends LactTransBase{
    ...
    public void testTrans() {
        ...
        PaymentMode paymentMode = PaymentMode.DeterminatePrincipal;        //还款方式: 确定本金
        ...
        segment.setTermMonth(terms);            //这里是多出来的
...
//            schedule.setPaymentAmt((Double)row[1]);
            schedule.setPrincipal((Double)row[1]);
