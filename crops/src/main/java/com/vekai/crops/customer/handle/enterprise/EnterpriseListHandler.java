...
@Component
public class EnterpriseListHandler extends MapDataListHandler {
    ...
    public Integer delete(DataForm dataForm, List<MapObject> dataList) {
        ...
        for (MapObject mapObject :dataList) {
            ...
            if (!BizConst.YES_NO_Y.equals(custPermit.getAllowHold())) {
                ...
                String entSql = "DELETE FROM CUST_ENT WHERE CUST_ID=:custId";
     ...
     * @return
     */
    public Boolean checkBusinessExists (DataForm dataform, MapObject object) {
        Boolean flag = false;
